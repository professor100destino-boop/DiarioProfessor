const CACHE='professor-control-offline-v2-3-freqschool-20260819';
const LOCAL=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./runtime-v23.js','./frequency-school.js','./session-fix.js','./home-actions.js','./advertencias.js','./school-filter-fix.js','./update-app.js','./parts/part00.txt','./parts/part01.txt','./parts/part02.txt','./parts/part03.txt','./parts/part04.txt','./parts/part05.txt','./parts/part06.txt','./parts/part07.txt','./parts/part08.txt','./parts/part09.txt','./parts/part10.txt','./parts/part11.txt'];
